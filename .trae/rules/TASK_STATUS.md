...
| `index/index.vue` 改造 | AI前端 | ⏸️ 待开始 | 首页 | 黑名单作者过滤（P1） |
...
| **前端功能** | | | | |
| 离线编辑支持 | AI前端 | ⏸️ 待开始 | 相关服务 | 离线队列 + 联网同步（P1） |
| 冲突解决机制 | AI前端 | ⏸️ 待开始 | 相关服务 | 多端冲突提示和解决（P2） |
| 自动同步优化 | AI前端 | ⏸️ 待开始 | 相关服务 | 登录全量同步 + 增量同步（P1） |
...
| 积分中心改造 | AI前端 | ⏸️ 待开始 | mine/index.vue | 仅展示真实行为记录（P1） |
